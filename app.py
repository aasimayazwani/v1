...
with st.sidebar:
    ...
    k_chunks = st.slider("Retriever top-k", 4, 20, 12, key="k")
...
if prompt := st.chat_input("Ask a question …"):
    ...
    # Convert bubble list → (q,a) pairs for memory-aware RAG
    ...
    # Optional: show source docs for RAG
    if show_src and rag_chain and isinstance(answer, dict) and "source_documents" in answer:
